...
## Ini final, masih tetap ada masalah karena attach file tidak sesuai dengan yang diharapkan walaupun file yang di lampirkan ada
from email.mime.text import MIMEText
from email.mime.multipart import MIMEMultipart
...
filename=input("Nama file yang akan di lampirkan: ")
